...
from cross_validation_test.pytorchtools import EarlyStopping
...
transform_train = transforms.Compose([transforms.Resize((40, 40)), transforms.RandomApply([
    ...
    for fold, (train_index, val_index) in enumerate(kfold.split(training_set)):
        ...
        for epoch in range(epochs):
            ...
            if early_stopping.early_stop:
                ...
                early_stopping.save_checkpoint(running_loss,model)
                break
            is_first = False
